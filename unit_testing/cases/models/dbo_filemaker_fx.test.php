 ...
 */	
	function testCreateFindDeleteRecordAll() {
		...
		//$result = $model->deleteAll(array('-recid' => $findResult[0]['TestArticle']['-recid']), FALSE);
		$result = $model->del();
 ...
 */	
	function testCreateHasManyFind() {
		...
		$commentModel->create();
		$saveResultComment = $commentModel->saveAll($_data['TestComment'], array('atomic' => FALSE));
